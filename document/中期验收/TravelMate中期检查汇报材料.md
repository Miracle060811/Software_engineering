...
![软件工程基础实践中期检查要求](./依据/课程中期检查要求截图.png)

### 1.2 材料提交安排

![中期检查材料提交安排](./依据/中期检查材料提交安排截图.png)
...
| 测试层级 | 已验证结果 | 证据位置 |
| :--- | :--- | :--- |
| 后端单元/集成测试 | 161/161 通过，34 个测试类 | `document/测试执行报告-2026-08-28.md`、Actions artifact `backend-test-reports` |
...
| 系统组件图与概要设计 | 已完成 | `document/软件概要设计说明书.md`、`document/概要设计说明/00_系统总体组件图.png` |
| 每个用例的组件级图 | 19/19 | `document/概要设计说明/HLD-FIG-02` 至 `HLD-FIG-20`，并保留 Mermaid 源文件 |
| 类图与详细设计 | 已完成 | `document/5组-软件详细设计说明.md`、6 张实现类图 |
| 每个用例的对象级图 | 19/19 | `document/详细设计说明/36_UC01` 至 `54_UC19`，并保留 Mermaid 源文件 |
| 完整追溯表 | 已完成 | `document/需求设计代码测试追溯表.md` |
...
| 证据 | 路径或链接 |
| :--- | :--- |
| 业务场景清单与正式用例 | `document/业务场景清单与用例说明.md` |
| 需求说明 | `document/5组-软件需求规格说明.md` |
| 概要设计 | `document/软件概要设计说明书.md` |
| 详细设计 | `document/5组-软件详细设计说明.md` |
| 追溯表 | `document/需求设计代码测试追溯表.md` |
| 测试报告 | `document/测试执行报告-2026-08-28.md` |
| 微服务中期基线 | `document/TravelMate中期验收基线.md` |
| 服务划分图 | `document/中期验收/TravelMate服务划分图.svg` |
