...
import com.travelmate.microservices.local.LocalOutboxEvent;
...
@Mapper
public interface LocalOutboxEventMapper extends BaseMapper<LocalOutboxEvent> {
    @Update("""
            UPDATE tm_local_outbox_event
